...
import com.udc.grandapp.adapters.DeviceUpdateRoutinesAdapter
...
class DevicesToRoutineUpdateRoutine : Fragment() {
    ...
    override fun onCreateView(inflater: LayoutInflater, container: ViewGroup?, savedInstanceState: Bundle?): View? {
        ...
        recyclerView.adapter = context?.let { DeviceUpdateRoutinesAdapter(it, deviceSummaryListExample, parentFragmentManager) {
